...
$mcount++;?>
 ...
 <?php endif; ?></div><div class="allpost-content">
    ...
    <a href="<?php the_permalink() ?>" rel="bookmark">
      ...
      <iframe id="facebook-like" src="//www.facebook.com/plugins/like.php?href=<?php echo get_site_url();?>/?p=<?php echo get_the_ID();?>&send=false&layout=button_count&width=450&show_faces=true&action=like&colorscheme=light" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
      </div>
