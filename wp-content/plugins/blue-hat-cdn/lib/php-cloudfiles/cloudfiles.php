...
/**
 */
if(!class_exists('NoSuchContainerException')) require BHN_PLUGIN_ADMIN_ROOT.DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.'php-cloudfiles'.DIRECTORY_SEPARATOR.'cloudfiles_exceptions.php';
if(!class_exists('CF_Http')) require BHN_PLUGIN_ADMIN_ROOT.DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.'php-cloudfiles'.DIRECTORY_SEPARATOR.'cloudfiles_http.php';
...
class CF_Object
{
    ...
    function _guess_content_type($handle) {
        ...
        if (function_exists("finfo_open")) {
			...
			if(is_file($magicMimeFilePath))
			{
				$finfo = @finfo_open(FILEINFO_MIME, $magicMimeFilePath);
