...
break;case "formedit":e.jqGrid("setSelection",d),e.jqGrid("editGridRow",d,k.editOptions)}};a.fn.fmatter.actions=function(c,b){var d={keys:!1,editbutton:!0,delbutton:!0,editformbutton:!1},e=b.rowId,f="";void 0!==b.colModel.formatoptions&&(d=a.extend(d,b.colModel.formatoptions));if(void 0===e||a.fmatter.isEmpty(e))return"";d.editformbutton?f+="<div title='"+a.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+("id='jEditButton_"+e+"' onclick=BHN.jQueryObj.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=BHN.jQueryObj(this).addClass('ui-state-hover'); onmouseout=BHN.jQueryObj(this).removeClass('ui-state-hover'); ")+
"><span class='ui-icon ui-icon-pencil'></span></div>":d.editbutton&&(f+="<div title='"+a.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+("id='jEditButton_"+e+"' onclick=BHN.jQueryObj.fn.fmatter.rowactions.call(this,'edit'); onmouseover=BHN.jQueryObj(this).addClass('ui-state-hover'); onmouseout=BHN.jQueryObj(this).removeClass('ui-state-hover') ")+"><span class='ui-icon ui-icon-pencil'></span></div>");d.delbutton&&(f+="<div title='"+a.jgrid.nav.deltitle+"' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' "+
("id='jDeleteButton_"+e+"' onclick=BHN.jQueryObj.fn.fmatter.rowactions.call(this,'del'); onmouseover=BHN.jQueryObj(this).addClass('ui-state-hover'); onmouseout=BHN.jQueryObj(this).removeClass('ui-state-hover'); ")+"><span class='ui-icon ui-icon-trash'></span></div>");f+="<div title='"+a.jgrid.edit.bSubmit+"' style='float:left;display:none' class='ui-pg-div ui-inline-save' "+("id='jSaveButton_"+e+"' onclick=BHN.jQueryObj.fn.fmatter.rowactions.call(this,'save'); onmouseover=BHN.jQueryObj(this).addClass('ui-state-hover'); onmouseout=BHN.jQueryObj(this).removeClass('ui-state-hover'); ")+
"><span class='ui-icon ui-icon-disk'></span></div>";f+="<div title='"+a.jgrid.edit.bCancel+"' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' "+("id='jCancelButton_"+e+"' onclick=BHN.jQueryObj.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=BHN.jQueryObj(this).addClass('ui-state-hover'); onmouseout=BHN.jQueryObj(this).removeClass('ui-state-hover'); ")+"><span class='ui-icon ui-icon-cancel'></span></div>";return"<div style='margin-left:8px;'>"+f+"</div>"};a.unformat=function(c,
...
function(c,b){var d=a.jgrid.formatter.date||{};void 0!==b.formatoptions&&(d=a.extend({},d,b.formatoptions));return a.fmatter.isEmpty(c)?a.fn.fmatter.defaultFormat(c,b):a.jgrid.parseDate(d.newformat,c,d.srcformat,d)}})(BHN.jQueryObj);
...
!0===this.p.frozenColumns){a(this.grid.fhDiv).remove();a(this.grid.fbDiv).remove();this.grid.fhDiv=null;this.grid.fbDiv=null;a(this).unbind(".setFrozenColumns");if(!0===this.p.hoverrows){var b;a("#"+a.jgrid.jqID(this.p.id)).bind("mouseover",function(c){b=a(c.target).closest("tr.jqgrow");"ui-subgrid"!==a(b).attr("class")&&a(b).addClass("ui-state-hover")}).bind("mouseout",function(c){b=a(c.target).closest("tr.jqgrow");a(b).removeClass("ui-state-hover")})}this.p.frozenColumns=!1}})}})})(BHN.jQueryObj);
...
""]):[!1,a.jgrid.edit.msg.customfcheck,""]}return[!0,"",""]}})})(BHN.jQueryObj);
...
"set");h||(h="first");var w=a(c).serializeArray(),t={};a.each(w,function(a,b){t[b.name]=b.value});"add"===e?a(this).jqGrid("addRowData",b,t,h):"set"===e&&a(this).jqGrid("setRowData",b,t)}})}})})(BHN.jQueryObj);
...
c+"_ilsave").addClass("ui-state-disabled");a("#"+c+"_ilcancel").addClass("ui-state-disabled");a("#"+c+"_iladd").removeClass("ui-state-disabled");a("#"+c+"_iledit").removeClass("ui-state-disabled")}})}})})(BHN.jQueryObj);
...
e[0])[0])try{b("input.hasDatepicker",e[0]).datepicker("hide")}catch(p){}b(document).mousemove(b.jqDnR.drag).mouseup(b.jqDnR.stop);return!1})})},l=function(a){return parseInt(e.css(a),10)||!1},m=function(a){return parseInt(g.css(a),10)||!1}})(BHN.jQueryObj);
...
min:function(){return""===d?parseFloat(m[a]||0):Math.min(parseFloat(d),parseFloat(m[a]||0))},max:function(){return""===d?parseFloat(m[a]||0):Math.max(parseFloat(d),parseFloat(m[a]||0))},count:function(){""===d&&(d=0);return m.hasOwnProperty(a)?d+1:0},avg:function(){return e.sum()}};if(!e[b])throw"jqGrid Grouping No such method: "+b;b=e[b]();null!=c&&("fixed"===g?b=b.toFixed(c):(c=Math.pow(10,c),b=Math.round(b*c)/c));return b}}})})(BHN.jQueryObj);
...
h&&d(e.rows[y]).find("div.treeclick").click()}}})})(BHN.jQueryObj);
...
!0});return{colModel:h,rows:e,groupOptions:b,groupHeaders:f,summary:v}},jqPivot:function(q,n,h,e){return this.each(function(){function v(b){var f=BHN.jQueryObj(r).jqGrid("pivotSetup",b,n),c=0<d.assocArraySize(f.summary)?!0:!1,e=d.jgrid.from(f.rows);for(b=0;b<f.groupOptions.groupingView.groupField.length;b++)e.orderBy(f.groupOptions.groupingView.groupField[b],"a","text","");BHN.jQueryObj(r).jqGrid(d.extend({datastr:d.extend(e.select(),c?{userdata:f.summary}:{}),datatype:"jsonstring",footerrow:c,userDataOnFooter:c,
colModel:f.colModel,viewrecords:!0,sortname:n.xDimension[0].dataName},h||{},f.groupOptions));f=f.groupHeaders;if(f.length)for(b=0;b<f.length;b++)f[b]&&f[b].groupHeaders.length&&BHN.jQueryObj(r).jqGrid("setGroupHeaders",f[b]);n.frozenStaticCols&&BHN.jQueryObj(r).jqGrid("setFrozenColumns")}var r=this;"string"===typeof q?d.ajax(d.extend({url:q,dataType:"json",success:function(b){v(d.jgrid.getAccessor(b,e&&e.reader?e.reader:"rows"))}},e||{})):v(q)})}})})(BHN.jQueryObj);
...
"<"+a.root+">"+xmlJsonClass.json2xml(b,a.ident)+"</"+a.root+">";break;case "jsonstring":d="{"+xmlJsonClass.toJson(b,a.root,a.ident,!1)+"}",void 0!==b.postData.filters&&(d=d.replace(/filters":"/,'filters":'),d=d.replace(/}]}"/,"}]}"))}}});return d},excelExport:function(a){a=c.extend({exptype:"remote",url:null,oper:"oper",tag:"excel",exportOptions:{}},a||{});return this.each(function(){if(this.grid){var d;"remote"===a.exptype&&(d=c.extend({},this.p.postData),d[a.oper]=a.tag,d=BHN.jQueryObj.param(d),d=-1!==
a.url.indexOf("?")?a.url+"&"+d:a.url+"?"+d,window.location=d)}})}})})(BHN.jQueryObj);
...
function tableToGrid(l,m){BHN.jQueryObj(l).each(function(){if(!this.grid){BHN.jQueryObj(this).width("99%");var b=BHN.jQueryObj(this).width(),c=BHN.jQueryObj("tr td:first-child input[type=checkbox]:first",BHN.jQueryObj(this)),a=BHN.jQueryObj("tr td:first-child input[type=radio]:first",BHN.jQueryObj(this)),c=0<c.length,a=!c&&0<a.length,k=c||a,d=[],e=[];BHN.jQueryObj("th",BHN.jQueryObj(this)).each(function(){0===d.length&&k?(d.push({name:"__selection__",index:"__selection__",width:0,hidden:!0}),e.push("__selection__")):(d.push({name:BHN.jQueryObj(this).attr("id")||BHN.jQueryObj.trim(BHN.jQueryObj.jgrid.stripHtml(BHN.jQueryObj(this).html())).split(" ").join("_"),
index:BHN.jQueryObj(this).attr("id")||BHN.jQueryObj.trim(BHN.jQueryObj.jgrid.stripHtml(BHN.jQueryObj(this).html())).split(" ").join("_"),width:BHN.jQueryObj(this).width()||150}),e.push(BHN.jQueryObj(this).html()))});var f=[],g=[],h=[];BHN.jQueryObj("tbody > tr",BHN.jQueryObj(this)).each(function(){var b={},a=0;BHN.jQueryObj("td",BHN.jQueryObj(this)).each(function(){if(0===a&&k){var c=BHN.jQueryObj("input",BHN.jQueryObj(this)),e=c.attr("value");g.push(e||f.length);c.is(":checked")&&h.push(e);b[d[a].name]=c.attr("value")}else b[d[a].name]=BHN.jQueryObj(this).html();a++});0<a&&f.push(b)});
BHN.jQueryObj(this).empty();BHN.jQueryObj(this).addClass("scroll");BHN.jQueryObj(this).jqGrid(BHN.jQueryObj.extend({datatype:"local",width:b,colNames:e,colModel:d,multiselect:c},m||{}));for(b=0;b<f.length;b++)a=null,0<g.length&&(a=g[b])&&a.replace&&(a=encodeURIComponent(a).replace(/[.\-%]/g,"_")),null===a&&(a=b+1),BHN.jQueryObj(this).jqGrid("addRowData",a,f[b]);for(b=0;b<h.length;b++)BHN.jQueryObj(this).jqGrid("setSelection",h[b])}})};
